...
DrpUploadTask.lua
Task to upload images to Dark Rush Photography
...
function DrpUploadTask.processRenderedPhotos(functionContext, exportContext)
    ...
    local progressScope = exportContext:configureProgress{
        title = numberOfImages > 1 and
            LOC('$$$/DarkRushPhotography/Upload/Progress=Uploading ^1 images to Dark Rush^R Photography.', numberOfImages) or
            LOC '$$$/DarkRushPhotography/Upload/Progress/One=Uploading one image to Dark Rush^R Photography.'
    }
